insert into restaurants_main(id, name, geoposition, adres) values (101, 'KFC 1', '50.06509,19.93986', 'Floriańska 33, 31-425 Kraków');
insert into restaurants_info(id, stars, description, food_delivery) values(101, 4, '', true);
insert into restaurants_plan_weekdays(id, open, close) values(101, '8:00', '23:30');
insert into restaurants_plan_saturday(id, open, close) values(101, '8:00', '23:30');
insert into restaurants_plan_sunday(id, open, close) values(101, '8:00', '23:30');

insert into restaurants_main(id, name, geoposition, adres) values (102, 'KFC 2', '50.06785,19.94587', 'Pawia 5, 31-154 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(103, 'KFC 3', '50.09296,19.92063', 'Opolska 60A, 31-355 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(104, 'KFC 4', '50.03662,19.94050', 'Wadowicka 2, 30-415 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(105, 'KFC 5', '50.09167,19.92668', 'Krowoderskich Zuchów 21, 31-271 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(106, 'Good Lood Blonia', '50.059408179645104,19.921864931621894', 'Krowoderskich Zuchów 21, 31-271 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(107, 'Good Lood Basztowa', '50.066976126796106,19.93850241684209', 'Basztowa 10, 31-141 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(108, 'Good Lood Matejki', '50.068057164637565,19.942432129608825', 'plac Jana Matejki 9, 31-157 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(109, 'Good Lood Krowodrza', '50.072413827733925,19.926202926234524', 'plac Axentowicza, 30-034 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(110, 'Good Lood Kazimierz', '50.049531975233606,19.944669933375426', 'plac Wolnica 11, 31-060 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(111, 'Cafe Camelot', '50.063096528036546,19.9391680134084', 'Świętego Tomasza 17, 33-332 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(112, 'Mleczarnia', '50.05148675720475,19.943828684572754', 'Rabina, Beera Meiselsa 20, 31-058 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(113, 'Blossom', '50.06928032606181,19.952713426901465', 'Apartamenty Novum, Rakowicka 20, 31-510 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(114, 'Cafe Szafe', '50.057843945898476,19.929687469230185', 'Felicjanek 10, 31-104 Kraków');
...
insert into restaurants_main(id, name, geoposition, adres) values(115, 'Costa Coffee', '50.06268386692502,19.93789928642227', 'Rynek Główny 41, 31-013 Kraków');
